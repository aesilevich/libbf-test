...
extern "C" void bf_const_log2_internal(bf_t *T, limb_t prec);
...
int main() {
    ...
    // bmp::bf_float a("7.50e-01");
    // bmp::bf_float b("2.0e+00");
    // bmp::bf_float res = pow(a, -b);
